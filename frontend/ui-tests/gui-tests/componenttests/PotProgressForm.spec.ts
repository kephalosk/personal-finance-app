...
const BASE_PATH: string = 'http://localhost:5173/showcase/PotProgressForm';

test('PotProgressForm-Desktop', async ({ page }): Promise<void> => {
...
test('PotProgressForm-Tablet', async ({ page }): Promise<void> => {
...
test('PotProgressForm-Mobile', async ({ page }): Promise<void> => {

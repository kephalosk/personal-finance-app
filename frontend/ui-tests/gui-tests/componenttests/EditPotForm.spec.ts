...
const BASE_PATH: string = 'http://localhost:5173/showcase/EditPotForm';

test('EditPotForm-Desktop', async ({ page }): Promise<void> => {
...
test('EditPotForm-Tablet', async ({ page }): Promise<void> => {
...
test('EditPotForm-Mobile', async ({ page }): Promise<void> => {
